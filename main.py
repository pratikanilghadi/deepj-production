...
from models import ProcessingRequest, SuccessResponse, ErrorResponse
from worker import run_audio_generation_job
...
async def create_processing_job(
    ...
    background_tasks.add_task(run_audio_generation_job, request)
